...
class AplikasiController extends Controller implements HasMiddleware
{
    ...
    public function store(Request $request)
    {
        $rules = [
            ...
            // Relax URL constraint to accept non-URL placeholders per import policy.
            'alamat_domain' => 'nullable|string|max:255',
            'server_type' => 'nullable|in:Load-Balance,WHM',
            // After schema change jenis_aplikasi is free-form (user keeps original values like "Lainnya").
