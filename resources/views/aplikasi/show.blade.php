            ...
            <div class="grid gap-6 md:grid-cols-2">
                <div class="space-y-6">
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="min-w-0 flex-1">
                            <dt class="text-sm font-medium text-gray-500 mb-1">Tipe Server</dt>
                            <dd class="text-lg">
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium 
                                    {{ $aplikasi->server_type == 'Load-Balance' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800' }}">
                                    {{ $aplikasi->server_type }}
                                </span>
                            </dd>
                        </div>
                    </div>
